...
# -*- coding: utf-8 -*-
"""
Plot training results for PPOLag.

Reads history_{run_id}.npz from pipelines/ppo_lag/ and generates plots in
pipelines/ppo_lag/figures/.

Usage:
    python pipelines/ppo_lag/plot_train.py
    python pipelines/ppo_lag/plot_train.py --runs 5 --window 200
"""
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description="Plot PPOLag training results")
