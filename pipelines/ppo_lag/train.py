...
# -*- coding: utf-8 -*-
"""
Train PPOLag on RAN slicing with cycling curriculum.

Results (history_*.npz) are saved inside pipelines/ppo_lag/.

Usage:
    python pipelines/ppo_lag/train.py
    python pipelines/ppo_lag/train.py --runs 1 --sequential --total-steps 10000
"""
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description="Train PPOLag on RAN slicing")
