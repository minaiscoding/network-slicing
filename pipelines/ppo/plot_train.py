...
# -*- coding: utf-8 -*-
"""
Plot training results for PPO.

Reads history_{run_id}.npz from pipelines/ppo/ and generates plots in
pipelines/ppo/figures/.

Usage:
    python pipelines/ppo/plot_train.py
    python pipelines/ppo/plot_train.py --runs 5 --window 200
"""
...
def plot(data, window, save_path):
    ...
    # ── Overview: violations MA, cumulative, resources MA ──
