...
# -*- coding: utf-8 -*-
"""
Plot evaluation results for PPO.

Reads eval_history_*.npz from pipelines/ppo/ and generates per-scenario
and summary plots in pipelines/ppo/figures/.

Usage:
    python pipelines/ppo/plot_eval.py
"""
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Plot PPO evaluation results")
