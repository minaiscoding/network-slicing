...
if __name__ == '__main__':
    ...
    parser.add_argument("--total-steps",        type=int,   default=3600000)
    parser.add_argument("--cost-limit",         type=float, default=25.0)
    parser.add_argument("--steps-per-episode",  type=int,   default=18000)
    parser.add_argument("--steps-per-epoch",    type=int,   default=36000)
