...
# -*- coding: utf-8 -*-
"""
Plot evaluation results for CPO.

Reads eval_history_*.npz from pipelines/cpo/ and generates per-scenario
and summary plots in pipelines/cpo/figures/.

Usage:
    python pipelines/cpo/plot_eval.py
"""
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Plot CPO evaluation results")
